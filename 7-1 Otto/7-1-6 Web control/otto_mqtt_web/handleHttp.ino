...
void handleRoot() {
  ...
  s=s+"<form method='POST' action='slide'>";
  s=s+"<input type='range' min='1' max='100' value=100 class='slider' name='myRange'>";
  s=s+"&nbsp&nbsp";
  s=s+"<input type='submit' value=' 실 행 '/></form>";
  //s=s+"<input type='range' min='1' max='100' value='50' class='slider' id='myRange'>";
  //s=s+"<div class='slidecontainer'><input type='range' min='1' max='100' value='50' class='slider' id='myRange'></div>";
  
  if(p4[0]==1)
    s=s+"<a href=\"p40\"><button style='background-color:Lime; color:blue;'>Left1 on</button></a>";
  else 
    s=s+"<a href=\"p40\"><button style='background-color:DarkGreen; color:white;'>Left1 off</button></a>";
  s=s+"&nbsp&nbsp";
  if(p4[1]==1) 
    s=s+"<a href=\"p41\"><button style='background-color:Lime; color:blue;'>Left2 on</button></a>";
  else 
    s=s+"<a href=\"p41\"><button style='background-color:DarkGreen; color:white;'>Left2 off</button></a>";
  s=s+"&nbsp&nbsp";
  if(p4[2]==1) 
    s=s+"<a href=\"p42\"><button style='background-color:Lime; color:blue;'>Right1 on</button></a>";
  else 
    s=s+"<a href=\"p42\"><button style='background-color:DarkGreen; color:white;'>Right1 off</button></a>";
   s=s+"&nbsp&nbsp";
  if(p4[3]==1) 
    s=s+"<a href=\"p43\"><button style='background-color:Lime; color:blue;'>Right2 on</button></a>";
  else 
    s=s+"<a href=\"p43\"><button style='background-color:DarkGreen; color:white;'>Right2 off</button></a>";
  s=s+"&nbsp&nbsp";  
...
void handleSlide() {
  ...
  char range[32] = "";
  server.arg("myRange").toCharArray(range, sizeof(range) - 1);
...
void handleP40() {
  Serial.println("P40");
  char aa[32] = "";
  server.arg("ab").toCharArray(aa, sizeof(ssid) - 1);
  Serial.println(aa);
  if(p4[0]==1) 
    p4[0]=0;
  else
